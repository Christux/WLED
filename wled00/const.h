...
#define USERMOD_ID_CHRISTUX_PING_PONG_CLOCK 66 //Usermod "usermod_v2_christux_ping_pong_clock.h"
#define USERMOD_ID_PIXELART_CLIENT       67 // Usermode "usermod_pixelart_client.h" 
